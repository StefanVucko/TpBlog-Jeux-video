...
<h2 class="text-success"><i class="fa fa-pencil"></i> Rédiger un nouvel article</h2>

<!-- Formulaire de saisie d'un nouvel article -->
<form class="generic-form" action="add_post.php" method="post">
    <fieldset>
        <legend class="text-success"><i class="fas fa-sticky-note text-success"></i> Nouvel article</legend>
        <ul>
            <li>
            ...
            <li>
                <button class="btn btn-secondary text-success" type="submit">Enregistrer</button>
