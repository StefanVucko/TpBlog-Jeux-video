...
<h2 class="text-center text-success"><i class="fa fa-pencil-alt"></i>- Editer un article -</h2>
...
<form class="generic-form" action="edit_post.php" method="post">
    ...
    <fieldset>
        <legend class="text-success"><i class="fas fa-sticky-note text-success"></i> Article</legend>
        <ul>
            <li>
            ...
            <li>
                <button class="btn btn-secondary bgGreen" type="submit">Mettre à jour</button>
