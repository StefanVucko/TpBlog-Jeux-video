...
<h2 class="text-center text-success"><i class="fa fa-file-text-o"></i>- Article -</h2>
...
<form class="generic-form" action="add_comment.php" method="POST">
    ...
    <fieldset>
        <legend class="text-success"><i class="fas fa-comment text-success"></i> Nouveau commentaire</legend>
        <ul>
            <li>
            ...
            <li>
                <button class="btn btn-secondary bgGreen" type="submit">Ajouter</button>
